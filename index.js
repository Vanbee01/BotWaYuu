...
/////////////////
const BotName = 'YuuXD BOT☄'; 
const instagram = 'https://instagram.com/wahyudin.979_'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@wahyudin.979_')
